        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LoanNumber = table.Column<string>(type: "nchar(9)", fixedLength: true, maxLength: 9, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    AdminUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beneficiaries_UserId_SavingsAccountId",
                table: "Beneficiaries",
                columns: new[] { "UserId", "SavingsAccountId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CardConsumptions_CommerceId_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanInstallments_DueDate_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CashierId_CreatedAt",
                table: "Transactions",
                columns: new[] { "CashierId", "CreatedAt" });
